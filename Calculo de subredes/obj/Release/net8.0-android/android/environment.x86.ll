...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 477160561, ; hash 0x1c70e471, from name: libaot-Calculo de subredes
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1588406897, ; hash 0x5ead2a71, from name: libaot-Calculo de subredes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 1912713405, ; hash 0x7201b0bd, from name: aot-Calculo de subredes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 3385589466, ; hash 0xc9cbfeda, from name: aot-Calculo de subredes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 453
	...
	%struct.DSOCacheEntry {
		i64 3528410160, ; hash 0xd24f4430, from name: Calculo de subredes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
	...
	%struct.DSOCacheEntry {
		i64 3562733627, ; hash 0xd45b003b, from name: Calculo de subredes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
