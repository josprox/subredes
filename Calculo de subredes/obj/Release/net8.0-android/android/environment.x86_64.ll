...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 570, ; uint32_t number_of_dso_cache_entries (0x23a)
	i32 33555166, ; uint32_t android_runtime_jnienv_class_token (0x20002de)
	i32 100671037, ; uint32_t jnienv_initialize_method_token (0x6001e3d)
	i32 100671036, ; uint32_t jnienv_registerjninatives_method_token (0x6001e3c)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle (0x0)
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 27
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-Xamarin.AndroidX.Collection.dll.so
		ptr null; void* handle (0x0)
	}, ; 34
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.92_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3798279056751776828, ; hash 0x34b632ad8f7ed43c, from name: Calculo de subredes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	%struct.DSOCacheEntry {
		i64 3918152802916674836, ; hash 0x36601337098cad14, from name: aot-Calculo de subredes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 4086097997890422625, ; hash 0x38b4bc7ae1b18761, from name: libaot-Calculo de subredes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 126
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 132
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.75_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10829370765502903315, ; hash 0x9649a755b2ccf413, from name: libaot-Calculo de subredes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 331
	...
	%struct.DSOCacheEntry {
		i64 13872492869133727665, ; hash 0xc084fec3cddaf7b1, from name: aot-Calculo de subredes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 17414663649587473758, ; hash 0xf1ad50528c91ad5e, from name: Calculo de subredes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculo de subredes.dll.so
		ptr null; void* handle (0x0)
	}, ; 533
...
@.env.3 = private unnamed_addr constant [37 x i8] c"54bf95c2-4781-403d-97f1-c51bbf6a6e19\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"com.josprox.subredes\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [34 x i8] c"libaot-Calculo de subredes.dll.so\00", align 16
...
@.DSOCacheEntry.35_name = private unnamed_addr constant [42 x i8] c"libaot-Xamarin.AndroidX.Collection.dll.so\00", align 16
...
@.DSOCacheEntry.42_name = private unnamed_addr constant [48 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.Common.dll.so\00", align 16
...
@.DSOCacheEntry.44_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.ViewModel.dll.so\00", align 16
...
@.DSOCacheEntry.75_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
...
@.DSOCacheEntry.89_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
...
@.DSOCacheEntry.92_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
